...
const flags = [
    // THIS WAS PARTIALLY AN ACT OF CLOD. IT WAS TASKED WITH REVIEWING DIFFICULTY RATINGS WEIGHTING RECOGNIZEABILITY, NICHESSE, AND HOW EASY IT IS TO SEE THROUGH ANOTHER FLAG. GOOD CHARACTER DESIGN MAKES ICONIC SILHOUETTES TWITTER POST.
    // IT DID A LOT OF DIFFICULTY RATINGS REALLY STUPID SO THIS FAR A LOT HAVE BEEN OVERHAULED AND WILL CONTINUE TO BE. FEEDBACK IS GREATLY APPRECIATED!
    { name: "Afghanistan", code: "af", difficulty: 3 },
    { name: "Albania", code: "al", difficulty: 2 },
    { name: "Algeria", code: "dz", difficulty: 3 },
    { name: "Andorra", code: "ad", difficulty: 4 },
    { name: "Angola", code: "ao", difficulty: 3 },
    { name: "Antigua and Barbuda", code: "ag", difficulty: 5 },
    { name: "Argentina", code: "ar", difficulty: 1 },
    { name: "Armenia", code: "am", difficulty: 4 },
    { name: "Australia", code: "au", difficulty: 1 },
    { name: "Austria", code: "at", difficulty: 3 },
    { name: "Azerbaijan", code: "az", difficulty: 4 },
    { name: "Bahamas", code: "bs", difficulty: 4 },
    { name: "Bahrain", code: "bh", difficulty: 3 },
    { name: "Bangladesh", code: "bd", difficulty: 2 },
    ...
    { name: "Bhutan", code: "bt", difficulty: 2 },
    ...
    { name: "Cambodia", code: "kh", difficulty: 2 },
    ...
    { name: "Chad", code: "td", difficulty: 5 },
    ...
    { name: "Croatia", code: "hr", difficulty: 3 },
    ...
    { name: "Eswatini", code: "sz", difficulty: 4 },
    ...
    { name: "Georgia", code: "ge", difficulty: 2 },
    ...
    { name: "Guinea", code: "gn", difficulty: 4 },
    { name: "Guinea-Bissau", code: "gw", difficulty: 5 },
    { name: "Guyana", code: "gy", difficulty: 4 },
    ...
    { name: "Indonesia", code: "id", difficulty: 3 },
    ...
    { name: "Luxembourg", code: "lu", difficulty: 4 },
    ...
    { name: "Mali", code: "ml", difficulty: 4 },
    ...
    { name: "Monaco", code: "mc", difficulty: 4 },
    { name: "Mongolia", code: "mn", difficulty: 4 },
    { name: "Montenegro", code: "me", difficulty: 4 },
    { name: "Morocco", code: "ma", difficulty: 3 },
    { name: "Mozambique", code: "mz", difficulty: 3 },
    ...
    { name: "North Macedonia", code: "mk", difficulty: 4 },
    ...
    { name: "Papua New Guinea", code: "pg", difficulty: 3 },
    ...
    { name: "Qatar", code: "qa", difficulty: 3 },
    ...
    { name: "Sri Lanka", code: "lk", difficulty: 3 },
    ...
    { name: "Uganda", code: "ug", difficulty: 4 },
